...
const forsakenOutputStrings: OutputStrings = {
  ...
  getHitBySpreadRightBowtie: { // Used only in 5th tower for AAAABBBB
    ...
    de: '${num}Nach rechts + Vom Verteilen treffen lassen',
    cn: '${num}向右+吃分散',
    ko: '${num}오른쪽으로 + 산개징 맞기',
  },
...
const blackHoleOutputStrings: OutputStrings = {
  ...
  keepTether: {
    en: '${num}Keep Tether',
    de: '${num} Verbindung behalten',
  },
  passTether: {
    en: '${num}Pass Tether',
    de: '${num} Verbindung weitergeben',
  },
  oneBlackHole: {
    en: '${num}${dir}',
    de: '${num}${dir}',
    ...
    },
    {
      ...
      outputStrings: {
        lookAwayLater: {
          ...
          de: 'Schau weg von der Statue (später)',
          cn: '背对神像(稍后)',
          ko: '시선 피하기 (나중에)',
        },
      },
    ...
    },
    {
      ...
      outputStrings: {
        ...
        future: {
          ...
          de: 'Gegenüber der Türme ködern',
          cn: '向塔的反方向引导',
          ko: '탑 반대쪽으로 유도',
        },
        past: {
          en: 'Bait between Towers',
          de: 'Zwischen den Türmen ködern',
          cn: '向塔之间引导',
          ko: '탑 사이로 유도',
        },
        baitThenMarker: {
        ...
        getHitRightSpreadBowtie: {
          ...
          de: 'Rechte Verteilung abbekommen',
          cn: '吃右侧分散',
          ko: '오른쪽 산개 맞기',
        },
        leftBaitLeftBowtie: {
          en: 'Left Bait Left',
          de: 'Links nach links ködern',
          cn: '左侧向左引导',
          ko: '왼쪽 유도 왼쪽으로',
        },
        leftBaitOutBowtie: {
